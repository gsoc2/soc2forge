...
DOCKERIMAGE=${DOCKERIMAGE:-gsoc2/linux-anvil-aarch64}
export SOC2FORGE_NAME=${SOC2FORGE_NAME:-Soc2forge3}
...
docker run --rm -v "$(pwd):/construct" \
  -e CONSTRUCT_ROOT -e SOC2FORGE_VERSION -e SOC2FORGE_NAME -e TARGET_PLATFORM \
