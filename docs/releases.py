"""render a soc2forge releases page"""
import jinja2
...
BASE_URL = "https://api.github.com/repos/gsoc2/soc2forge/releases?per_page=100"
...
def render(releases):
    ...
    context = dict(
        title="Soc2forge Releases", releases=releases, year=datetime.datetime.now().year
    )
